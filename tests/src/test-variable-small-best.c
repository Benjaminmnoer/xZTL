 ...
 * The test is designed for small object writes, which doesn't fill out the sector completely, 
...
/* Object Size */
/* 4032 bytes, meaning just below sector size. This is to show the best case scenario.  */
#define TEST_BUFFER_SZ (4032) 
