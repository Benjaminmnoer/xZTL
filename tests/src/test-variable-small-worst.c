 ...
 * The test is designed for small object writes, which only surpass the sector boundary by a small amount, 
...
/* Object Size */
/* 4160 bytes, meaning just above sector size. This is to show the worst case scenario.  */
#define TEST_BUFFER_SZ (4160) 
